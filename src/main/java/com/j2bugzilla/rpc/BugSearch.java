 ...
 * @author Tom
 * 
 * This class was modified by Michael Pietsch (2016)
 */
public class BugSearch implements BugzillaMethod {
    ...
    public enum SearchLimiter {
        ...
        CREATOR("creator"),
        /**
         * dateTime: could be used to search bugs since this date
         */
        SINCE("last_change_time");
    ...
    public static class SearchQuery {
         ...
         * @param query   A {@code Object} to filter with. If its a string the whole string will be matched, or not at all --
         *                Bugzilla does not perform substring matching. Arrays are also possible.
         */
